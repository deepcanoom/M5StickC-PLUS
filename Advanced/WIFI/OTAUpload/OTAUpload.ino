...
* Date: 2021/9/18
*******************************************************************************
  PC and M5StickCPlus can only be used on the same wifi.  电脑和
M5StickCPlus需在同一wifi下才可使用 When the OTA is ready, restart the Arduino
...
void setup() {
    ...
    ArduinoOTA.setHostname(
        "M5StickC");  // Set the network port name.  设置网络端口名称
