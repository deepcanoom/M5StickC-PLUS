...
class FunctionRequestHandler : public RequestHandler {
   public:
    ...
    bool canHandle(HTTPMethod requestMethod, String requestUri) override {
        ...
        if (requestUri != _uri) return false;
...
class StaticRequestHandler : public RequestHandler {
   public:
    ...
    bool handle(WebServer& server, HTTPMethod requestMethod,
        ...
        // part only works to send gzip via content encoding when a non
        // compressed is asked for if you point the the path to gzip you will
        // serve the gzip as content type "application/x-gzip", not text or
        // javascript etc...
