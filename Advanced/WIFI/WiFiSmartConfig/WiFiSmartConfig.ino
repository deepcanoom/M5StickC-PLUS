...
*to relevant WIFI 通过手机APP填写WIFI配置信息使 M5StickC连接至相关WIFI APP
*Download Address:
...
void setup() {
    ...
    while (
        WiFi.status() !=
        WL_CONNECTED) {  // M5StickC will connect automatically upon receipt of
                         // the configuration information, and return true if
                         // the connection is successful.
                         // 收到配网信息后M5StickC将自动连接，若连接成功将返回true
        delay(500);
        M5.Lcd.print(".");
    }
